...
rc_front = Roboclaw("/dev/ttyACM3", 115200)
...
while(1):
	rc_front.ForwardM1(address_front,0)
	rc_front.ForwardM2(address_front,0)
	rc_back.ForwardM1(address_back,0)
	rc_back.ForwardM2(address_back,0)
